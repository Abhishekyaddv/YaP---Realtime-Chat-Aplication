    ...
    <>
      ...
      <div className="flex-1 px-6 overflow-y-auto py-8">
        {messages.length > 0 && !isMessagesLoading ? (
          ...
          // if we don't have messages and we are not in loading state the messages will be dislayed
        ...
        ) : isMessagesLoading ? <MessagesLoadingSkeleton /> :( // if messages are in loading state we will show the loading skeleton
